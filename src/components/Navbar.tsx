    ...
    <nav className="flex justify-between items-center px-8 py-4 shadow-md h-[10%] w-full">
      ...
      <ul className="flex gap-4 items-center justify-center">
        {navLinks.map((link, key) => (
          ...
          >
            <span>{link}</span>
            <span className="absolute left-0 -bottom-[15%] h-px w-0 bg-purple-700 transition-all duration-[0.5s] ease-in-out group-hover:w-full group-hover:shadow-[0_0_2px_#7e22ce,0_0_10px_#7e22ce,0_0_30px_#7e22ce]"></span>
          </li>
        ))}
        <Settings />
      </ul>
